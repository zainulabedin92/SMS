          ...
          selection.forEach(function (attachment) {
            ...
            if (attachment.id) {
              ...
              if (attachment.type === 'image') {
                ...
                listImages.append('<li class="lp-meta-box__file_list-item image" data-attachment_id="' + attachment.id + '"><img src="' + attachmentImage + '" /><ul class="actions"><li><a href="#" class="delete"></a></li></ul></li>');
              } else {
